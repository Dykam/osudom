...
namespace TreeCore
{
	...
	{		
        ...
        uint ManualInsertAt(int position, INode node);
        /// <summary>
        ...
        uint ManualInsertAt(int position, INodeList nodes);
        /// <summary>
        ...
        uint ManualRemove(INodeList nodes);
        /// <summary>
        ...
        /// <param name="nodes">The Nodes to remove.</param>
        /// <returns>Returns the number of Nodes which where in the NodeList.</returns>
        uint AutomatedRemove(INodeList nodes);
	}
}
